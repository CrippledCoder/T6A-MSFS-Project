/***********************************************************/
/***                                                     ***/
/*** TO FIND THE EDITABLE SIMVARS SEARCH FOR "EDIT HERE" ***/
/***                                                     ***/
/***********************************************************/
    ...
    Update() {
        ...
        if (this.CanUpdate()) {
            if (this.updateElectricity()) {
				...
				/***********************************************************/
				/***                                                     ***/
				/*** EDIT THESE LINES TO SPECIFY THE SIMVARS TO BE SHOWN ***/
				/***                                                     ***/
                this.comActiveFreq.textContent = SimVar.GetSimVarValue("NAV DME:" + this.radioIndex, "nautical miles").toFixed(1)
				if (SimVar.GetSimVarValue("NAV HAS NAV:" + this.radioIndex, "Bool")) {
					this.comStandbyFreq.textContent = SimVar.GetSimVarValue("NAV RELATIVE BEARING TO STATION:" + this.radioIndex, "degrees").toFixed(1);
				/***                                                     ***/
				/***********************************************************/
				} else {
                ...
                this.cavActiveFreq.textContent = this.getActiveNavFreq();
                switch (this.navMode) {
                    case 0:
